...
if __name__ == '__main__':
    ...
    for i in range(10):
        ...
        # print(height, width, "Offset: ", offset, "Min_pos", min_pos, "Max Pos: ", max_pos, )
    ...
    free_spaces = height * width - len(list_elf_pos)  # area - amount of elfs
    print("Width: ", width, "Height: ", height)
    print("Amount of Empty Ground Tiles within Rectangle (Solution Part One): ", free_spaces)
